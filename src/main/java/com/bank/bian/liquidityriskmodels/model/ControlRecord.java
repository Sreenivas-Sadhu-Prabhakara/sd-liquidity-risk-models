package com.bank.bian.liquidityriskmodels.model;
...
/**
 * The BIAN control record for this service domain: "Liquidity Risk Model Development Project".
 *
 ...
 * to its asset type (Liquidity Risk Model). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Liquidity Risk Model Development Project";
